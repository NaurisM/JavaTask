...
public class CountryService implements ICountryService {
    ...
    public List<String> sortListByArea() {
        ...
        Collections.sort(countryList, Comparator.comparingInt(Country::getArea).reversed());
    ...
    public List<String> sortListByPopulation() {
        ...
        Collections.sort(countryList, Comparator.comparingInt(Country::getPopulation).reversed());
        countryList.subList(0, 10)
                .forEach(country -> populationList.add(country.getName() + " : " + country.getPopulation()));
